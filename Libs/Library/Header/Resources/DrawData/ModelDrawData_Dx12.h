...
namespace ButiEngine {
	struct ModelDrawData_Dx12 :public ModelDrawData,public DrawData_Dx12 {
		ModelDrawData_Dx12(const ModelTag& arg_model, const ShaderTag& arg_shader, std::shared_ptr<IRenderer> arg_shp_renderer, std::weak_ptr<GraphicDevice_Dx12> arg_wkp_graphicDevice,  std::shared_ptr< DrawInformation >arg_shp_drawInfo);
