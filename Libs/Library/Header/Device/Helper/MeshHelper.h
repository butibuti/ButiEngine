...
namespace ButiEngine {
	...
	public:
		...
		static void CreatePlane(Vector2 size, Vector3 offset, float UVMax, const UINT arg_verticalSeparate, const UINT arg_horizontalSeparate, const std::vector<Color>& arg_colors, bool flat, BackupData<Vertex::Vertex_UV_Normal_Color>& outputMeshData);
